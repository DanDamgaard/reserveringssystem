...
namespace api.Data
{
    public class UserData : IUserData
    {
        ...
        public Task InsertUser(UserModel user) => 
            _db.SaveData("Call CreateUserProcedure(@Username, @Password, @Department, @Type)", 
            new { Username = user.Username, Password = user.Password, Department = user.Department, Type = user.UserRole });
