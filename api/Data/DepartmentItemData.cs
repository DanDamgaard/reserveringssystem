...
namespace api.Data
{
    public class DepartmentItemData : IDepartmentItemData
    {
        ...
        public Task UpdateDepartmentItem(DepartmentItemModel DepartmentItem) => 
            _db.SaveData("Call UpdateDepartmentItemProcedure(@Id, @ItemNo, @Status, @CustomerName, @CustomerPhone, @StartDate, @EndDate)", 
                new { Id = DepartmentItem.Id,ItemNo = DepartmentItem.ItemNo, Status = DepartmentItem.Status, CustomerName = DepartmentItem.CustomerName, 
                    CustomerPhone = DepartmentItem.CustomerPhone, StartDate = DepartmentItem.StartDate, EndDate = DepartmentItem.EndDate });
